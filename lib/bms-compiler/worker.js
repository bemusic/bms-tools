...
/* Generated by Opal 0.7.2 */
Opal.modules["keysounder"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  ...
  Opal.add_stubs(['$lambda', '$sub', '$+', '$extname', '$log', '$read', '$new', '$process!', '$get_target_filename', '$==', '$raise', '$write', '$output', '$each', '$call', '$!', '$load_bms!', '$process_objects!', '$join', '$private', '$map', '$parse_line', '$split', '$generate_objects!', '$group_by', '$to_proc', '$length', '$[]', '$reject', '$tap', '$[]=', '$channel', '$select', '$ln?', '$value=', '$value', '$delete', '$=~', '$to_i', '$warn', '$p', '$values', '$sort', '$keys', '$parse', '$push', '$objects', '$attr_reader', '$respond_to?', '$min', '$max', '$resolve', '$parse_objects', '$floor', '$/', '$*', '$divide', '$<<', '$line', '$to_r', '$to_f', '$text', '$index', '$is_a?', '$puts', '$-']);
  return (function($base) {
    var self = $module($base, 'BMSCompiler');

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1, $c, TMP_2;

    Opal.cdecl($scope, 'FILENAME_STRATEGIES', [($a = ($b = self).$lambda, $a.$$p = (TMP_1 = function(f){var self = TMP_1.$$s || this;
if (f == null) f = nil;
    return f.$sub(/_src(\.\w+)$/, "\\1")}, TMP_1.$$s = self, TMP_1), $a).call($b), ($a = ($c = self).$lambda, $a.$$p = (TMP_2 = function(f){var self = TMP_2.$$s || this;
if (f == null) f = nil;
    return f.$sub(/(?:\.\w+)?$/, "_key"['$+']($scope.get('File').$extname(f)))}, TMP_2.$$s = self, TMP_2), $a).call($c)]);
    ...
    (function($base, $super) {
      ...
      Opal.defs(self, '$compile', function(filename) {
        var self = this, text = nil, keysounder = nil, target_filename = nil;

        $scope.get('Logger').$log("Processing: " + (filename));
        text = $scope.get('File').$read(filename);
        keysounder = $scope.get('Keysounder').$new(text);
        keysounder['$process!']();
        target_filename = self.$get_target_filename(filename);
        if (target_filename['$=='](filename)) {
          self.$raise("Target filename is same as input filename!")};
        $scope.get('Logger').$log("Writing to " + (target_filename));
        return $scope.get('File').$write(target_filename, keysounder.$output());
      });

      return (Opal.defs(self, '$get_target_filename', function(filename) {try {

        var $a, $b, TMP_3, self = this;

        ($a = ($b = $scope.get('FILENAME_STRATEGIES')).$each, $a.$$p = (TMP_3 = function(strategy){var self = TMP_3.$$s || this, $a, target_filename = nil;
if (strategy == null) strategy = nil;
        target_filename = strategy.$call(filename);
          if ((($a = target_filename['$=='](filename)['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            Opal.ret(target_filename)
            } else {
            return nil
          };}, TMP_3.$$s = self, TMP_3), $a).call($b);
        return self.$raise("Unable to derive a file name!");
        } catch ($returner) { if ($returner === Opal.returner) { return $returner.$v } throw $returner; }
      }), nil) && 'get_target_filename';
    })(self, null);

    (function($base, $super) {
      function $Keysounder(){};
      var self = $Keysounder = $klass($base, $super, 'Keysounder', $Keysounder);

      var def = self.$$proto, $scope = self.$$scope;

      def.lines = def.text = def.objects = nil;
      ...
      def['$load_bms!'] = function() {
        var $a, $b, TMP_4, self = this;

        self.lines = ($a = ($b = self.text.$split(/\r\n|\r|\n/)).$map, $a.$$p = (TMP_4 = function(line){var self = TMP_4.$$s || this;
if (line == null) line = nil;
        return self.$parse_line("" + (line) + "\r\n")}, TMP_4.$$s = self, TMP_4), $a).call($b);
        return self.objects = self['$generate_objects!']();
      };

      def['$process_objects!'] = function() {
        var $a, $b, $c, TMP_5, self = this, groups = nil, lnhead = nil, replaced = nil;

        groups = ($a = ($b = self.objects).$group_by, $a.$$p = "position".$to_proc(), $a).call($b);
        $scope.get('Logger').$log("Found " + (self.objects.$length()) + " note objects on " + (groups.$length()) + " rows.");
        lnhead = $hash2([], {});
        replaced = 0;
        ($a = ($c = groups.$keys().$sort()).$each, $a.$$p = (TMP_5 = function(position){var self = TMP_5.$$s || this, $a, $b, $c, TMP_6, $d, TMP_8, objects = nil, notes = nil, bgm = nil, used = nil;
if (position == null) position = nil;
        objects = groups['$[]'](position);
          notes = ($a = ($b = objects).$reject, $a.$$p = "bgm?".$to_proc(), $a).call($b);
          bgm = ($a = ($c = $hash2([], {})).$tap, $a.$$p = (TMP_6 = function(hash){var self = TMP_6.$$s || this, $a, $b, TMP_7, $c, $d;
if (hash == null) hash = nil;
          return ($a = ($b = ($c = ($d = objects).$select, $c.$$p = "bgm?".$to_proc(), $c).call($d)).$each, $a.$$p = (TMP_7 = function(object){var self = TMP_7.$$s || this;
if (object == null) object = nil;
            return hash['$[]='](object.$channel(), object)}, TMP_7.$$s = self, TMP_7), $a).call($b)}, TMP_6.$$s = self, TMP_6), $a).call($c);
          used = $hash2([], {});
          return ($a = ($d = notes).$each, $a.$$p = (TMP_8 = function(object){var self = TMP_8.$$s || this, $a, $b, $c, bgm_channel = nil, key = nil;
if (object == null) object = nil;
          if ((($a = ($b = object['$ln?'](), $b !== false && $b !== nil ?lnhead['$[]'](object.$channel()) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
              return (($a = [lnhead.$delete(object.$channel()).$value()]), $b = object, $b['$value='].apply($b, $a), $a[$a.length-1])
              } else {
              if ((($a = object.$value()['$=~'](/^Z([1-9A-Y])$/i)) !== nil && (!$a.$$is_boolean || $a == true))) {
                bgm_channel = "b" + ((($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i(36));
                key = bgm['$[]'](bgm_channel);
                if (key !== false && key !== nil) {
                  if ((($a = used['$[]'](bgm_channel)) !== nil && (!$a.$$is_boolean || $a == true))) {
                    $scope.get('Logger').$warn(position, "Reusing " + (bgm_channel) + " (" + (used['$[]'](bgm_channel)) + ")")};
                  ($a = bgm_channel, $b = used, ((($c = $b['$[]']($a)) !== false && $c !== nil) ? $c : $b['$[]=']($a, key.$value())));
                  (($a = [used['$[]'](bgm_channel)]), $b = object, $b['$value='].apply($b, $a), $a[$a.length-1]);
                  (($a = ["00"]), $b = key, $b['$value='].apply($b, $a), $a[$a.length-1]);
                  replaced = replaced['$+'](1);
                  } else {
                  $scope.get('Logger').$warn(position, "Keysound at " + (bgm_channel) + " not found");
                  self.$p(($a = ($b = bgm.$values()).$map, $a.$$p = "channel".$to_proc(), $a).call($b));
                };};
              if ((($a = object['$ln?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
                return lnhead['$[]='](object.$channel(), object)
                } else {
                return nil
              };
            }}, TMP_8.$$s = self, TMP_8), $a).call($d);}, TMP_5.$$s = self, TMP_5), $a).call($c);
        return $scope.get('Logger').$log("Replaced " + (replaced) + " notes.");
      };

      def.$parse_line = function(text) {
        var self = this;

        return $scope.get('BMSLine').$new(text);
      };

      return (def['$generate_objects!'] = function() {
        var $a, $b, TMP_9, self = this, resolver = nil;

        resolver = $scope.get('BMSChannelResolver').$new();
        return ($a = ($b = []).$tap, $a.$$p = (TMP_9 = function(objects){var self = TMP_9.$$s || this, $a, $b, TMP_10;
          if (self.lines == null) self.lines = nil;
if (objects == null) objects = nil;
        return ($a = ($b = self.lines).$each, $a.$$p = (TMP_10 = function(line){var self = TMP_10.$$s || this, $a, sentence = nil;
if (line == null) line = nil;
          sentence = $scope.get('BMSChannelSentence').$parse(line, resolver);
            if (sentence !== false && sentence !== nil) {
              } else {
              return nil;
            };
            if ((($a = sentence.$channel()['$=~'](/^(?:[123457]\S|b\d+)$/)) !== nil && (!$a.$$is_boolean || $a == true))) {
              return ($a = objects).$push.apply($a, [].concat(sentence.$objects()))
              } else {
              return nil
            };}, TMP_10.$$s = self, TMP_10), $a).call($b)}, TMP_9.$$s = self, TMP_9), $a).call($b);
      }, nil) && 'generate_objects!';
    })(self, null);

    (function($base, $super) {
      function $BMSChannelResolver(){};
      var self = $BMSChannelResolver = $klass($base, $super, 'BMSChannelResolver', $BMSChannelResolver);
      ...
      def.$initialize = function() {
        ...
        return self.hash = $scope.get('Hash').$new(0);
      };

      return (def.$resolve = function(measure, channel) {
        var $a, $b, self = this;

        if (channel['$==']("01")) {
          ($a = measure, $b = self.hash, $b['$[]=']($a, $b['$[]']($a)['$+'](1)));
          return "b" + (self.hash['$[]'](measure));
          } else {
          return channel
        };
      }, nil) && 'resolve';
    ...
    (function($base, $super) {
      function $BMSLine(){};
      var self = $BMSLine = $klass($base, $super, 'BMSLine', $BMSLine);
      ...
      def.$initialize = function(line) {
        var self = this;

        return self.text = line;
      };

      def['$[]='] = function(range, replacement) {
        var $a, self = this;

        if ((($a = self.text['$respond_to?']("[]=")) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.text['$[]='](range, replacement)
          } else {
          return self.text = self.text['$[]']($range(0, range.$min(), true))['$+'](replacement)['$+'](self.text['$[]']($range(range.$max()['$+'](1), -1, false)))
        };
      };
    ...
    (function($base, $super) {
      function $BMSChannelSentence(){};
      var self = $BMSChannelSentence = $klass($base, $super, 'BMSChannelSentence', $BMSChannelSentence);

      var def = self.$$proto, $scope = self.$$scope;

      self.$attr_reader("line", "measure", "channel", "objects");

      def.$initialize = function(line, measure, channel, data, data_index, resolver) {
        var self = this;

        self.line = line;
        self.measure = measure;
        self.channel = (function() {if (resolver !== false && resolver !== nil) {
          return resolver.$resolve(measure, channel)
          } else {
          return channel
        }; return nil; })();
        return self.objects = self.$parse_objects(data, data_index);
      };

      def.$parse_objects = function(data, data_index) {
        var $a, $b, TMP_11, self = this, i = nil, objects = nil, total = nil;

        i = 0;
        objects = [];
        total = (data.$length()['$/'](2)).$floor();
        ($a = ($b = ($range(0, total, true))).$each, $a.$$p = (TMP_11 = function(n){var self = TMP_11.$$s || this, $a, value = nil, position = nil;
          if (self.measure == null) self.measure = nil;
if (n == null) n = nil;
        i = n['$*'](2);
          value = data['$[]']($range(i, i['$+'](2), true));
          if ((($a = value['$==']("00")['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            position = self.measure.$to_i(10)['$+'](self.$divide(n, total));
            return objects['$<<']($scope.get('BMSObject').$new(self.$line(), data_index['$+'](i), position, self));
            } else {
            return nil
      ...
      def.$divide = function(a, b) {
        var $a, self = this;

        if ((($a = b['$respond_to?']("to_r")) !== nil && (!$a.$$is_boolean || $a == true))) {
          return a['$/'](b.$to_r())
          } else {
          return a['$/'](b.$to_f())
        };
      ...
      return (Opal.defs(self, '$parse', function(line, resolver) {
        var $a, self = this, match = nil, measure = nil, channel = nil, data = nil, data_index = nil;
        if ($gvars["~"] == null) $gvars["~"] = nil;

        if (resolver == null) {
          resolver = nil
        }
        if ((($a = line.$text()['$=~'](/^\s*#(\d\d\d)(\d\d):(\S+)/)) !== nil && (!$a.$$is_boolean || $a == true))) {
          match = $gvars["~"];
          measure = match['$[]'](1);
          channel = match['$[]'](2);
          if ((($a = channel['$==']("02")['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            data = match['$[]'](3);
            data_index = line.$text().$index(":")['$+'](1);
            return self.$new(line, measure, channel, data, data_index, resolver);
            } else {
            return nil
          };
          } else {
    ...
    (function($base, $super) {
      function $BMSObject(){};
      var self = $BMSObject = $klass($base, $super, 'BMSObject', $BMSObject);

      var def = self.$$proto, $scope = self.$$scope;

      def.line = def.index = def.sentence = nil;
      self.$attr_reader("position", "sentence");

      def.$initialize = function(line, index, position, sentence) {
        var self = this;
      ...
      def.$value = function() {
        ...
        return self.line.$text()['$[]']($range(self.index, self.index['$+'](2), true));
      };

      def['$value='] = function(new_value) {
        var self = this;

        return self.line['$[]=']($range(self.index, self.index['$+'](2), true), new_value);
      };

      def.$channel = function() {
        var self = this;

        return self.sentence.$channel();
      };
      ...
      return (def['$ln?'] = function() {
        var self = this;

        return self.$channel()['$=~'](/^[56]/);
      }, nil) && 'ln?';
    })(self, null);
    ...
    (function($base) {
      ...
      Opal.defs(self, '$log', function(args) {
        var $a, $b, self = this;
        if ($gvars.stderr == null) $gvars.stderr = nil;

        args = $slice.call(arguments, 0);
        if ((($a = (($b = args.$length()['$=='](1)) ? args['$[]'](0)['$is_a?']($scope.get('String')) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return $gvars.stderr.$puts(args['$[]'](0))
          } else {
          return $gvars.stderr.$puts(($a = ($b = args).$map, $a.$$p = "inspect".$to_proc(), $a).call($b).$join(" "))
        };
      });

      Opal.defs(self, '$warn', function(position, message) {
        var self = this;

        return self.$log("WARNING at " + (position.$to_i()) + "(" + (position['$-'](position.$to_i())) + "): " + (message));
      });
    })(self);
  })(self)
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$attr_reader', '$push', '$new', '$process!', '$get_target_filename', '$out', '$output', '$compile']);
  self.$require("opal");
  self.$require("keysounder");
  (function($base, $super) {
    function $FakeStderr(){};
    var self = $FakeStderr = $klass($base, $super, 'FakeStderr', $FakeStderr);

    var def = self.$$proto, $scope = self.$$scope;

    def.out = nil;
    self.$attr_reader("out");
    ...
    return (def.$puts = function(args) {
      var $a, self = this;

      args = $slice.call(arguments, 0);
      return ($a = self.out).$push.apply($a, [].concat(args));
    }, nil) && 'puts';
  })(self, null);
  (function($base) {
    var self = $module($base, 'JSBMSCompiler');

    var def = self.$$proto, $scope = self.$$scope;

    Opal.defs(self, '$compile', function(str, filename) {
      var self = this, old_stderr = nil, x = nil, target_filename = nil;
      if ($gvars.stderr == null) $gvars.stderr = nil;

      try {
      old_stderr = $gvars.stderr;
      $gvars.stderr = $scope.get('FakeStderr').$new();
      x = (($scope.get('BMSCompiler')).$$scope.get('Keysounder')).$new(str);
      x['$process!']();
      target_filename = (function() {if (filename !== false && filename !== nil) {
        return (($scope.get('BMSCompiler')).$$scope.get('Compiler')).$get_target_filename(filename)
        } else {
        return nil
      }; return nil; })();
      return [$gvars.stderr.$out(), x.$output(), target_filename];
      } finally {
      $gvars.stderr = old_stderr
      };
    })
  })(self);
...
var BMSCompiler = {
  compile: function(str, filename) {
    return $scope.get('JSBMSCompiler').$compile(str, filename)
  }
}

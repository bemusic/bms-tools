...
if (f == null) f = nil;
    return f.$sub(/[_\-]src(\.\w+)$/, "\\1")}, TMP_1.$$s = self, TMP_1), $a).call($b), ($a = ($c = self).$lambda, $a.$$p = (TMP_2 = function(f){var self = TMP_2.$$s || this;
if (f == null) f = nil;
    return f.$sub(/((?:\.\w+)?)$/, "_key\\1")}, TMP_2.$$s = self, TMP_2), $a).call($c)]);
